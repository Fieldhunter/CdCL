...
parser.add_argument('--max_lr_sr', type=float, default=2e-4,
                    help='CosineAnnealingLR max lr')
parser.add_argument('--min_lr_sr', type=float, default=1e-6,
                    help='CosineAnnealingLR min lr')
parser.add_argument('--lr_decay_encoder', type=int, default=60,
                    help='learning rate decay per N epochs')
parser.add_argument('--lr_decay_sr', type=int, default=60,
                    help='unused parameters')
parser.add_argument('--decay_type', type=str, default='step',
                    help='unused parameters')
parser.add_argument('--gamma_encoder', type=float, default=0.2,
                    help='learning rate decay factor for step decay')
parser.add_argument('--gamma_sr', type=float, default=0.5,
                    help='unused parameters')
parser.add_argument('--optimizer', default='ADAMW',
                    choices=('SGD', 'ADAM', 'ADAM', 'RMSprop'),
